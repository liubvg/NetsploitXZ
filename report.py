...
def generate_html_report(
    ...
    parts.append(f"<title>{e(REPORT_TITLE)}</title><style>{_HTML_CSS}</style></head><body><div class='wrap'>")
...
def _html_footer() -> str:
    return (
        "<div class='footer'>Authorized testing only &middot; Exploit matches are leads, "
        "not confirmed vulnerabilities.</div>"
    )
